...
some other ruleset that depends on rules_jfrog, or in a nested
...
```sh
OVERRIDE="--override_repository=rules_jfrog=$(pwd)"
echo "common $OVERRIDE" >> ~/.bazelrc
```

This means that any usage of `@rules_jfrog` on your system will point to this folder.
...
https://github.com/albertocavalcante/rules_jfrog/actions/workflows/tag.yaml
